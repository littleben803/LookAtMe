...
final class TemplateStore: ObservableObject {
    private let templates: [BannerTemplate] = [
        ...
        BannerTemplate(id: "concert-husband-look", title: "老公看这里！", scene: .concert, text: "老公看这里！", isPro: true),
        BannerTemplate(id: "concert-tonight", title: "今晚为你而来", scene: .concert, text: "今晚为你而来", isPro: true),
        ...
        BannerTemplate(id: "confession-meet", title: "遇见你真好", scene: .confession, text: "遇见你真好", isPro: true),
        BannerTemplate(id: "confession-hand", title: "可以牵手吗", scene: .confession, text: "可以牵手吗", isPro: true),
        ...
        BannerTemplate(id: "birthday-forever-18", title: "永远十八岁", scene: .birthday, text: "永远十八岁", isPro: true),
        BannerTemplate(id: "birthday-dream", title: "心想事成", scene: .birthday, text: "心想事成", isPro: true),
        ...
        BannerTemplate(id: "pickup-safe", title: "一路平安", scene: .pickup, text: "一路平安", isPro: true),
        BannerTemplate(id: "pickup-long-time", title: "好久不见", scene: .pickup, text: "好久不见", isPro: true),
        ...
        BannerTemplate(id: "fun-stage", title: "让我上台", scene: .fun, text: "让我上台", isPro: true),
        BannerTemplate(id: "fun-camera", title: "摄像老师看这里", scene: .fun, text: "摄像老师看这里", isPro: true)
    ]
